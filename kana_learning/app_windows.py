"""
All of the various windows used in the app.
"""
...
import kana_learning.app_widgets as aw
...
class App(tk.Frame):
    ...
    def __init__(self, root, ss=None):  
    ...
    def load_frames(self):
        ...
        # The instructions frame at the top of every window.
        ...
        self.windows["setup"].take_focus() # Fix after testing
        

class Popup(tk.Toplevel):
    """Toplevel to message the user.  Prevents user from using parent
...
class Learn(AppWindow):
    ...
    def _load_next_kana(self):
        ...
        try:
            ...
            pop = Popup(self, 
                "You've looped through all the kana! Starting again...")
...
class Speak(AppWindow):
    ...
    def _cleanup(self):
        """Prevent the gif from looping while its window isn't
        displayed."""
